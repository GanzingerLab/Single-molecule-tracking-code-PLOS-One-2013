function [save_name_MSD,save_name_JD]= make_directoryMSD(parameters)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
directory_name = strcat(parameters.exp_name,'\','MSD Analysis Results\');
...
directory_name = strcat(parameters.exp_name,'\','JD Analysis Results\');
